document.addEventListener("DOMContentLoaded", () => {
    ...
    resumeForm.addEventListener('submit', (event: Event) => {
        ...
        // Disable form elements to prevent further editing
        disableFormElements(resumeForm);
    });
});

// Function to disable form elements after resume generation
function disableFormElements(form: HTMLFormElement) {
